...
export function initCommission(data: Commission) {
    return {
        type: PROFILE.INIT_COMMISSION,
        payload: data,
    };
}

export function updateCommission(data: Commission) {
    return {
        type: PROFILE.UPDATE_COMMISSION,
        payload: data,
    };
}
