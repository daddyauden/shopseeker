...
export const createMerchantExecutive = (data) => {
...
export const updateMerchantExecutive = (data) => {
...
export const createMerchantProfile = (data) => {
...
export const updateMerchantExternal = (data) => {
...
export const updateMerchantBrand = (data) => {
