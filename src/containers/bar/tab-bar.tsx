    ...
    const routes = [
        {
            ...
            icon: (
                <Text
                    className="iconfont mh-home-outline"
                    style={[Style.f_size_50, Style.f_color_dark_bold]}
                ></Text>
            ),
            selecedIcon: (
                <Text
                    className="iconfont mh-home-outline"
                    style={[Style.f_size_50, Style.f_color_first]}
                ></Text>
            ),
        },
        {
            ...
            icon: (
                <Text
                    className="iconfont mh-search-outline"
                    style={[Style.f_size_50, Style.f_color_dark_bold]}
                ></Text>
            ),
            selecedIcon: (
        ...
        },
        {
            ...
            icon: (
                <Div>
                    <Text
                        className="iconfont mh-cart-outline"
            ...
            selecedIcon: (
                <Div>
                    <Text
                        className="iconfont mh-cart-outline"
                        style={[Style.f_size_45, Style.f_color_first]}
                    ></Text>
                    {itemsSize > 0 && (
                        <Div
                            style={[
        ...
        },
        {
            ...
            icon: (
                <Text
                    className="iconfont mh-person-outline"
                    style={[Style.f_size_45, Style.f_color_dark_bold]}
                ></Text>
            ),
            selecedIcon: (
