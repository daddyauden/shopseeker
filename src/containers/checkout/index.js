...
const CheckoutOrder = (props) => {
    ...
    const [shippingTip, setShippingTip] = useState(tipModel.default);
    ...
    return (
        ...
        >
            ...
            >
                <Text
                    style={[Style.f_size_15, Style.f_weight_500, Style.m_b_4]}
                >
                    {trans("getOrderTitle")}
                </Text>
                <Div style={[Style.column, Style.m_b_2]}>
                    <Div
                        style={[
                            ...
                            shippingType === "pickup" && Style.bg_color_light,
                        ]}
                    ...
                    <Div
                        style={[
                            ...
                            Style.border_round_1,
                            Style.b_light_medium,
                            shippingType === "delivery" && Style.bg_color_light,
                        ]}
                    >
                        <Div
                            style={[
                            ...
                            onClick={() => onChange("shippingType", "delivery")}
                        >
                            <Div style={[Style.row, Style.column_center]}>
                                <Icon
                                    name="car-outline"
                        ...
                        {shippingType === "delivery" && (
                            <Div style={[Style.column]}>
                                ...
                                >
                                    ...
                                    />
                                    <Text
                                        style={[Style.f_size_13, Style.m_l_2]}
                                    >
                    ...
                    >
                        ...
                        >
                            <Text style={[Style.f_size_15, Style.f_weight_500]}>
                                {trans("deliveryTip")}
                                <Text style={[Style.f_size_13, Style.m_l_1]}>
            ...
            <Button
                ...
                loading={loading}
                style={[Style.m_v_4, Style.w_p100]}
            />
...
const mapDispatchToProps = (dispatch) => {
    return {
        update_merchant: (data) => dispatch(updateMerchantRequest(data)),
    };
};
